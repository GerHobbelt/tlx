...
void test_md5()
{
    die_unequal(md5_hex(""), "d41d8cd98f00b204e9800998ecf8427e");
    die_unequal(md5_hex("a"), "0cc175b9c0f1b6a831c399e269772661");
    die_unequal(md5_hex("abc"), "900150983cd24fb0d6963f7d28e17f72");
    die_unequal(md5_hex("message digest"), "f96b697d7cb7938d525a2f31aaf161d0");
    die_unequal(md5_hex("abcdefghijklmnopqrstuvwxyz"),
                "c3fcd3d76192e4007dfb496cca67e13b");
    die_unequal(
        md5_hex(
            "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"),
        "d174ab98d277d9f5a5611c2c9f419d9f");
    die_unequal(md5_hex("123456789012345678901234567890123456789012345678901234"
...
void test_sha1()
{
    die_unequal(sha1_hex(""), "da39a3ee5e6b4b0d3255bfef95601890afd80709");
    die_unequal(sha1_hex("abc"), "a9993e364706816aba3e25717850c26c9cd0d89d");
    die_unequal(
        sha1_hex(
            "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"),
        "761c457bf73b14d27e9e9265c46f4b4dda11f940");
    die_unequal(sha1_hex("12345678901234567890123456789012345678901234567890123"
